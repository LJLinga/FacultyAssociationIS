<html>
	...
	<?php
		...
		$queryLoan = "SELECT ML.RECORD_ID, ML.DATE_APPLIED, ML.MEMBER_ID, M.LASTNAME, M.FIRSTNAME, D.DEPT_NAME, P.PAYROLL_NAME, L.AMOUNT, L.INTEREST, 
		...
		if (isset($_POST['approve'])) {
			...
			$queryTransaction = "INSERT INTO TRANSACTIONS (MEMBER_ID, AMOUNT, TXN_DATE, TXN_TYPE, TXN_STATUS, EMP_ID_INVOLVED) 
								 VALUES ($resultRow['MEMBER_ID'], 0, NOW(), 1, 'FALP Application Approved', {$empid})";
			...
			$queryTransaction = "INSERT INTO TRANSACTIONS (MEMBER_ID, AMOUNT, TXN_DATE, TXN_TYPE, TXN_STATUS, EMP_ID_INVOLVED) 
								 VALUES ($resultRow['MEMBER_ID'], 0, NOW(), 1, 'FALP Application Rejected', {$empid})";
